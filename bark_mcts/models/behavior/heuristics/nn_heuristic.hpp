...
public:
    ...
    std::pair<SE, std::unordered_map<mcts::AgentIdx, SO>> calculate_heuristic_values(const std::shared_ptr<mcts::StageNode<S,SE,SO,H>> &node) {
        ...
        for (int i=0; i< output.cols(); i++){
            ...
            output_vector[4] = 1.0-20*(1.0-output(0, 4));
            output_vector[5] = 1.0-20*(1.0-output(0, 5));
            output_vector[8] = 1.0-20*(1.0-output(0, 8));
            output_vector[9] = 1.0-20*(1.0-output(0, 9));
            output_vector[12] = 1.0-20*(1.0-output(0, 12));
            output_vector[13] = 1.0-20*(1.0-output(0, 13));
