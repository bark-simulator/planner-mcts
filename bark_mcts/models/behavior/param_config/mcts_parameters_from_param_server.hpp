...
inline mcts::MctsParameters MctsParametersFromParamServer(const commons::ParamsPtr& params,
    ...
    parameters.hypothesis_statistic.UPPER_COST_BOUND = params->GetReal("Mcts::HypothesisStatistic::UpperCostBound", "Lower cost bound used for normalization in UCT Statistic", 1);
