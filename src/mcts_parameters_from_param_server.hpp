...
mcts::MctsParameters MctsParametersFromParamServer(const commons::ParamsPtr& params,
    ...
    parameters.hypothesis_belief_tracker.HISTORY_LENGTH = params->GetInt("Mcts::BeliefTracker::HistoryLength", "Length of probability history", 4);
    ...
    parameters.hypothesis_belief_tracker.POSTERIOR_TYPE = params->GetReal("Mcts::BeliefTracker::PosteriorType", "Zero for product, One for sum", 1);
